...
// This function opens the side panel by setting its width to 180px and adjusting the left margin of the main content.
function openNav() {
    document.getElementById("side-panel").style.width = "180px";
    document.getElementById("booking-main").style.marginLeft = "200px";
}

// This function closes the side panel by setting its width to 0 and adjusting the left and right margins of the main content.
function closeNav() {
